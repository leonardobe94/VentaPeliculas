...
public class ListaPeliculas<T> implements IDatos<T> {
	...
	public ListaPeliculas() {
		// Creo una conexi√≥n para para cargar la base de datos en la lista
	...
	@Override
	public void aÒadirPelicula(String titulo, String director, int fechaEstreno, String categoria,
	...
	@Override
	public void aÒadirPelicula(T pelicula, String titulo, String director, int fechaEstreno, String categoria,
			String resumen, String url) {
		// TODO Auto-generated method stub
